...
export function JournalEntryModal({ open, onOpenChange, onSuccess }: JournalEntryModalProps) {
          ...
          <div className="space-y-2">
            <div className="flex items-end justify-between gap-3 flex-wrap">
              <div className="space-y-1">
                <div className="text-xs text-muted-foreground">Search accounts</div>
            ...
            <div className="flex items-center justify-between mt-4">
              <div className="text-xs text-muted-foreground">Tip: Each line must have either a debit or a credit, not both.</div>
              <div className="flex items-center gap-2">
                <Button variant="outline" onClick={addLine}>
                  <Plus className="w-4 h-4 mr-2" />
                  Add Line
                </Button>
                <Button onClick={postEntry} disabled={posting || !totals.balanced}>
